...
const props = withDefaults(defineProps<{ title?: string, description?: string, headline?: string, image?: string }>(), {
  title: '',
  description: '',
  headline: null,
  image: null
  ...
  <div class="w-full h-full flex flex-col justify-center bg-[#212121]">
    <svg class="absolute top-0 right-0" width="1200" height="675" viewBox="0 0 1200 675" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g style="mix-blend-mode:overlay" opacity="0.7" filter="url(#filter0_f_448_25)">
        <circle cx="901.5" cy="45.5" r="199.5" fill="#ba1200" />
        <circle cx="600.5" cy="216.5" r="199.5" fill="#175069" />
        <circle cx="179.5" cy="317.5" r="199.5" fill="#ba1200" />
      </g>
      <defs>
        <filter id="filter0_f_448_25" x="-240" y="-374" width="1561" height="1111" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
          ...
          <feGaussianBlur stdDeviation="210" result="effect1_foregroundBlur_448_25" />
        </filter>
      </defs>
    </svg>
    ...
    <div v-if="image" class="absolute top-[150px] right-[100px]">
      <img class="w-[300px] h-[300px] object-cover rounded-full" :src="image"/>
    </div>
  </div>
</template>
